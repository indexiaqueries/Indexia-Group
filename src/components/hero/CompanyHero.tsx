...
const CompanyHero = ({
  ...
  return (
    ...
    >
      <div
        className="hero-panel-glass fade-up relative max-w-5xl p-4 sm:p-6 lg:max-w-[calc(100%-40rem)] lg:p-7 lg:ml-0 lg:mr-auto"
      ...
      >
        ...
        <h1 className="font-display text-[clamp(24px,4vw,44px)] mt-2 font-bold leading-[1.06] text-white">
          {name}
        </h1>
        ...
        {tagline && (
          <p className="mt-2 sm:mt-4 text-sm sm:text-lg font-semibold italic text-(--color-yellow)">“{tagline}”</p>
        )}

        <p className="mt-3 max-w-2xl text-[14px] sm:text-base leading-7 sm:leading-8 text-white/80">{desc}</p>
