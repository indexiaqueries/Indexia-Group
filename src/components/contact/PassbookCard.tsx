...
const PassbookCard = () => {
  ...
  return (
    <div className="relative mx-auto w-full max-w-sm">
      ...
      <div
        className="passbook-in relative -rotate-3 rounded-3xl p-5 shadow-2xl ring-1 ring-black/5 transition-transform duration-300 ease-out hover:rotate-0 sm:p-7"
        style={{ backgroundColor: colors.paper }}
      >
        <div className="absolute bottom-8 inset-s-0 top-8 flex -translate-x-1/2 flex-col justify-between rtl:translate-x-1/2">
        ...
        <div className="seal-stamp-in absolute -bottom-5 -inset-e-5" aria-hidden="true">
