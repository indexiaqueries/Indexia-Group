  ...
  <>
    ...
    >
      <div className={`mx-auto max-w-xl sm:max-w-2xl lg:max-w-3xl ${isHome ? "bnr-text-zoom" : ""}`}>
        {/* Unified frosted glass card — deep navy, not black */}
        <div className="relative rounded-3xl border border-white/15 bg-(--color-navy-deep)/70 px-6 py-6 sm:px-10 sm:py-8 shadow-[0_8px_32px_rgba(2,16,26,0.5)]">
          {/* Accent line */}
