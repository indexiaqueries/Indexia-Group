...
const FoundationQR = () => {
  ...
  return (
    <div
      className={`fixed inset-e-4 bottom-24 z-40 transition-all duration-500 sm:inset-e-6 sm:bottom-28 ${
        visible
    ...
    >
      {!expanded ? (
        ...
        >
          ...
          <span className="absolute -top-1 -inset-e-1 flex h-4 w-4 items-center justify-center rounded-full bg-(--color-yellow) text-[8px] font-bold text-(--color-deep)">
            ❤
          </span>
        </button>
      ) : (
