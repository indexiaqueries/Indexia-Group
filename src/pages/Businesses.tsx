...
const About = () => {
  ...
  const entryNo = String(selected + 1).padStart(2, "0");

  return (
    <>
      <SEO
        title="Our Businesses — Finance, Agro, Trade & Logistics"
      ...
      >
        ...
        <div className="container relative z-10">
          ...
          <div className="mx-auto mb-10 flex max-w-5xl flex-wrap justify-center gap-2.5 sm:mb-12">
